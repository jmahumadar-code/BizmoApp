...
public class FragmentMapsASearch extends Fragment implements View.OnClickListener, TextView.OnEditorActionListener {

    private static final String TAG = FragmentMapsASearch.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_maps_a_search, container, false);
